...
n <- 10000 # number of data points to construct
error.var.1 <- 0.01 # variance of the idiosyncratic error term
error.var.2 <- 0.1 # variance of error process for measurements of catch
...
catch <- effort + 5*effort * exp(1.2*logpopgrowth) + nets / 3 + error.normal2
```
